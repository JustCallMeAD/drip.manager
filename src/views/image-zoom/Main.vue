            ...
            <div class="preview">
              <div class="leading-relaxed">
                ...
                <div class="w-3/5 h-64 mr-6 float-left image-fit">
                  <img
                    alt="Drip Manager"
                    :src="require(`@/assets/images/${$f()[0].images[1]}`)"
                    data-action="zoom"
                    class="w-full rounded-md"
                  />
                </div>
                ...
                <p class="mb-5">
                  ...
                  +1 VHS hashtag. Wolf umami Carles Marfa, 90's food truck Cosby
                  sweater. Fanny pack try-hard keytar pop-up readymade, master
                  cleanse four loko trust fund polaroid salvia. Photo booth
                  kitsch forage chambray, Carles scenester slow-carb lomo
