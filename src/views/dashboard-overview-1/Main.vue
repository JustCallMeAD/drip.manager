              ...
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    ...
                    <div class="text-base text-gray-600 mt-1">Available</div>
                  </div>
                  <div class="text-3xl font-medium leading-8 mt-6">0.15</div>
                  <div class="text-base text-gray-600 mt-1">5.46 USDT</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    ...
                    <div class="text-base text-gray-600 mt-1">Deposits</div>
                  </div>
                  <div class="text-3xl font-medium leading-8 mt-6">415.15</div>
                  <div class="text-base text-gray-600 mt-1">9895.95 USDT</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  ...
                  <div class="text-base text-gray-600 mt-1">Claimed</div>
                  </div>
                  <div class="text-3xl font-medium leading-8 mt-6">250.565</div>
                  <div class="progress h-4 rounded mt-3">
                      <div class="progress-bar bg-theme-1 rounded" style='width:25%' role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                      </div>
                  </div>
                </div>
              </div>
              ...
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    ...
                    <div class="text-base text-gray-600 mt-1">Max Payout</div>
                  </div>
                  <div class="text-3xl font-medium leading-8 mt-6">1500</div>
                  <div class="text-base text-gray-600 mt-1">Capped at 100000</div>
                </div>
              </div>
            </div>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const test = async () => {
      const faucet = await smManager.getFaucetContract(authManager.getCurrentUserAddress())
      alert(await faucet.getClaimsAvailable())
    }
