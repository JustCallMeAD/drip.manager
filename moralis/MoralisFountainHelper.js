...
async function getFountainStatsAtBlock(contract, blockNumber) {
  let stats = {}
  ...
  stats.bnbDripRatio =
    ...
    (await contract.methods
      .getTokenToBnbOutputPrice(one.toString())
      .call({}, blockNumber))

  return stats
}

const FOUNTAIN_ADDRESS = '0x4Fe59AdcF621489cED2D674978132a54d432653A'
const FOUNTAIN_ABI = [
  {
    inputs: [
      {
